...
main()
{
     ...
     strcpy(stringa1, "Mario Rossi"); /* prima di provere strncpy riportiamo il valore di stringa1 a Mario Rossi*/
     strncpy(stringa1, stringa2, 5);
     printf("Stringa 1 -->%s\n", stringa1); /* da notare che strncpy non aggiunge il carattere /0 e la stringa
